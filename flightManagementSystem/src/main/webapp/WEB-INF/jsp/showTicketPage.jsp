...
<section class="w3l-about-breadcrumb text-left">
    <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
      <div class="container py-2">
        ...
        <ul class="breadcrumbs-custom-path mt-2">
          ...
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span>Confirm Cancellation</li>
        </ul>
      </div>
    </div>
  </section>
    <div class="ticketcontainer">
        ...
        <div class="buttons">
            <a href="/cancelBooking" class="btn btn-primary">Back</a>
            <a href="/cancel" class="btn btn-secondary">Cancel Booking</a>
        </div>
    </div>
